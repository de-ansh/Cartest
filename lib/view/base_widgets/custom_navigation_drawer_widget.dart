...
import '../screens/customer/appointment/allAppointment.dart';
            ...
            builder: (context, model, child) =>ListView(
                ...
                children: [
                  ...
                  getListTile(context,Icons.local_offer,'Special Offers',6),
                      getListTile(context, Icons.calendar_today, 'Appointments', 7),
               //   getListTile(context,Icons.home,'My Cart',6),
                 // getListTile(context,Icons.home,'My Order',7),
                  getListTile(context,Icons.home,'Logout',8),
                ],
              ),
            ),
          ),
    ...
    onTap: () {
      switch(index){
        ...
        case 7 :  Navigator.push(context,
          MaterialPageRoute(builder: (context) => AllAppointmnet()),
        );
        break;
        case 8 :  Navigator.push(context,
        ...
        break;
        case 10 :  Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context) => LoginPage()),
        );
        break;
      }

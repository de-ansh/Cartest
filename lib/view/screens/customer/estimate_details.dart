...
class _EstimateDetailsState extends State<EstimateDetails> {
  ...
  final serviceProvider= locator<ServiceProvider>();
              ...
              children: [
                Container(
                  ...
                  child: Consumer<AppointmentProvider>(
                    builder: (context, model, child) =>  CustomButton(
                      ...
                      onTap: () {
                        model.SaveAppointment(accept: true,active: true,availableTime: '10:00 AM',date: '${widget.date}',
                            garrageId: 1,status: 'New Arrival',SubServiceId: 1,time: "${widget.time}",userId: 1,VehicleId: 1 );
                ...
                Container(
                  ...
                  child: Consumer<BidProvider>(
                      builder: (context, model, child) =>CustomButton(onTap: (){
                        model.SaveBid(created: '1/2/2023', createdBy: "Ashish", updated: '1/2/2023', updatedBy: "Ashish",  active: true,);
                        ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
                          content: Text('Your Bid added Succesfully '),
                          backgroundColor: Colors.green,
                        ));
                        Navigator.push(
                            context,

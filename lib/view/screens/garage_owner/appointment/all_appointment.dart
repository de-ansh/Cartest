...
class _AllAppointmentState extends State<AllAppointment> {
  ...
  void setState(VoidCallback fn) {
    ...
    super.setState(fn);
    appointmentProvider.getAppointmentByGarageId(authProvider.userDetails!.id);
    customerNameController.text= appointmentProvider.getAppointmentByGarageId(authProvider.userDetails!.id).toString();
     ...
     //height: MediaQuery.of(context).size.height-120,
      child: Consumer<AppointmentProvider>(
        builder: (context, model, child) => ListView.builder(
          shrinkWrap: true,
          itemCount: model.allAppointment.length,
              ...
              child: Container(
                ...
                child: ListTile(
                  ...
                  subtitle: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text( model.allAppointment[index].date),
                      SizedBox(height: 7,),
                      Container(
                        height: 25,
                        child:ElevatedButton(
                          ...
                          child: Padding(
                            ...
                            child: Text( model.allAppointment[index].status,
                                style: TextStyle(
                                    fontSize: 14,
                                    color: Colors.white
                                )),
